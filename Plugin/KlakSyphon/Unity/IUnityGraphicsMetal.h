...
{
    NSBundle*               (UNITY_INTERFACE_API * MetalBundle)(void);
    id<MTLDevice>(UNITY_INTERFACE_API * MetalDevice)(void);

    id<MTLCommandBuffer>(UNITY_INTERFACE_API * CurrentCommandBuffer)(void);
    ...
    id<MTLCommandEncoder>(UNITY_INTERFACE_API * CurrentCommandEncoder)(void);
    ...
    void(UNITY_INTERFACE_API * EndCurrentCommandEncoder)(void);

    // returns MTLRenderPassDescriptor used to create current MTLCommandEncoder
    MTLRenderPassDescriptor* (UNITY_INTERFACE_API * CurrentRenderPassDescriptor)(void);
